        ...
        <Card className="mt-4 bg-muted/40">
          <CardContent className="p-6 space-y-4">
            ...
            <div className="text-sm text-muted-foreground mt-6">
              ...
              Aigoat does not store your payment credentials. They are encrypted
              and passed to third-party payment vendor through their API that we
              use to process all payments. This API allows us to create a
              protected link to the payment method if the card was used to
              purchase anything on our website and the transaction was
              successful.
            </div>
